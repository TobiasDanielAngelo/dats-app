      ...
      <div className="lg:flex-grow py-5 flex justify-center max-h-[85vh]">
        ...
        >
          {!SideA ? (
            ...
            <div
              className="lg:overflow-scroll m-2 min-h-[80vh] border border-teal-500 dark:border-gray-700 rounded-lg"
              style={{
          ...
          {!SideB ? (
            ...
            <div
              className="overflow-scroll m-2 min-h-[80vh] border border-teal-500 dark:border-gray-700 rounded-lg items-center justify-center"
              style={{
